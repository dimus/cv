...
\cvitem{Management}{Agile Programming techniques}
\cvitem{DevOps}{Linux System Administration, Chef, Docker, Kubernetes}
\cvitem{Languages}{Ruby, Scala, Python, R, JavaScript, C, Assembly, Java, Perl, PHP, Cold Fusion, etc.}
\cvitem{Markup}{HTML, CSS, SASS, HAML, Markdown, \LaTeX}
\cvitem{Design}{Blender, Photoshop, Gimp}
